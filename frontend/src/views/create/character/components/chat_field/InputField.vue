<template>
    <form v-if="!showMic" @submit.prevent="handleSend" class="absolute bottom-4 left-5 h-12 w-100 flex items-center">
        <input
            ref="input-ref"
            v-model="message"
...
import streamApi from "@/utils/http/streamApi";
...
const initAudioStream = () => {
    ...
    audioPlayer.play().catch(e => console.error("Waiting for user interact to play audio"));
};
