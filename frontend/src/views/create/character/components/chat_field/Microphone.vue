<template>
    <div class="absolute bottom-4 left-5 h-12 w-100 flex items-center bg-black/30 backdrop-blur-sm rounded-2xl">
...
import CONFIG_API from "@/utils/config";
...
const startRecording = async () => {
    ...
    try {
        ...
        console.error("VAD initiation failed:", e);
    }
};
